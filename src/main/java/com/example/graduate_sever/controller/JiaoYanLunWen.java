...
//        System.out.println(chanXueYanDTO.getKey()+"______"+chanXueYanDTO.getPageIndex()+"_______"+chanXueYanDTO.getPageSize());
    ...
    @RequestMapping(value = "/deleteJiaoYanLunWen", method = RequestMethod.POST, produces = "application/json;charset=UTF-8")
    public JsonBean deleteJiaoYanLunWen(@RequestParam(value = "ids") List<Integer> ids) {
