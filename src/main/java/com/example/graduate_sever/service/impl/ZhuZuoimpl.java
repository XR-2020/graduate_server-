...
public class ZhuZuoimpl implements ZhuZuoService {
    ...
    public JsonBean deleteZhuZuo(List<Integer> ids) {
        for (Integer id:ids) {
            ...
            chanXueYanMapper.deletePeople(id,9);
        }
    ...
    @Override
    public List<TableData> waitingzhuzuo(DTO dTO) {
        List<ZhuZuo> list=mapper.waitingzhuzuo(dTO);
    ...
    @Override
    public List<Integer> getZhuZuoDetailBadge(Integer id) {
        List<People> people=mapper.getZhuZuoDetail(id);
